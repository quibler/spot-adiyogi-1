...
const MEDALS = [
  {
    ...
    message: "Inconceivable! You've reached mythic status!",
  },
  {
    threshold: 150,
    name: "Legendary",
    ...
    message: "Legendary performance! You're in a league of your own!",
  },
  {
    threshold: 100,
    name: "Platinum",
    ...
    message: "Shining bright with platinum skills!",
  },
  {
    threshold: 80,
    name: "Diamond",
    emoji: "💎",
    color: "text-cyan-400",
    message: "Dazzling diamond quality!",
  },
  {
    threshold: 60,
    name: "Gold",
  ...
  },
  {
    ...
    emoji: "🥈",
    color: "text-gray-300",
    message: "Solid silver, keep going!",
  },
  {
    threshold: 20,
    name: "Bronze",
    ...
    message: "Great start with bronze!",
  },
];
